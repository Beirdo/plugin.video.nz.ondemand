...
class parliament:
 def item(self):
  ...
  item['videoInfo']["Title"] = 'Parliament TV - Live Stream'
  item['videoInfo']["Thumb"] = os.path.join(config.__path__, "resources/images/%s.png" % item['channel'])
  item['videoInfo']["Plot"] = "Parliament TV provides live broadcasts from the House of Representatives. Question time is replayed each day at 6pm and 10pm."
